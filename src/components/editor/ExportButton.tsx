...
import { LoaderCircle, Download, AlertCircle } from 'lucide-react';
...
export default function ExportButton() {
    ...
    const canExport = currentProject?.metadata && !isExporting;
        ...
        <div className='p-3 rounded-2xl flex flex-col gap-2 bg-neutral-800'>
            ...
            <div className="flex flex-row items-center justify-between">
                ...
                <Button 
                    ...
                    size={'lg'} 
                    className="bg-white/90 hover:bg-white/80 text-neutral-800"
                >
                    {isExporting ? 
